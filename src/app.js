...
function calcular() {
    ...
    const resultado = calcularComisionTotal(datos, { metas, pagos, multConversion, multEmpatia, multProceso, multMora });

    updateProgress('progInterno', calcularNivel(datos.montoInterno, 'interno'));
    updateProgress('progExterno', calcularNivel(datos.montoExterno, 'externo'));
    updateProgress('progRecuperado', calcularNivel(datos.montoRecuperado, 'recuperado'));
    updateProgress('progCantidad', calcularNivel(datos.cantidad, 'cantidad'));
